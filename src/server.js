...
const AUTHORIZED_ACTIONS = new Set([
  ...
  'START_GPS', 'SEARCH_NUMBER', 'HIGHLIGHT_ADDRESSES_BY_VOIE'
]);
...
AFFICHAGE:  new Set(['HIGHLIGHT_ROAD', 'HIGHLIGHT_PLACE', 'SHOW_LAYER', 'HIDE_LAYER', 'FOCUS_ROAD', 'FOCUS_PLACE', 'HIGHLIGHT_ADDRESSES_BY_VOIE']),
